...
There are some programs that are not plugged into the CMake build system which
you might find interesting. You would need to build those programs yourself.
These programs reside in [`other/fun`](other/fun) directory.
...
| Name                   | Description     | Expected    | Default Value       |
:                        :                 : Value       :                     :
| ---------------------- | --------------- | ----------- | ------------------- |
| `AUTOTEST`             | Enable          | ON or OFF   | OFF                 |
:                        : autotests       :             :                     :
:                        : (mainly for     :             :                     :
:                        : CI).            :             :                     :
| `BOOTSTRAP_DAEMON`     | Enable building | ON or OFF   | ON                  |
:                        : of              :             :                     :
:                        : tox-bootstrapd, :             :                     :
:                        : the DHT         :             :                     :
:                        : bootstrap node  :             :                     :
...
:                        : Unix-like       :             :                     :
:                        : systems only.   :             :                     :
| `BUILD_MISC_TESTS`     | Build           | ON or OFF   | OFF                 |
:                        : additional      :             :                     :
:                        : tests.          :             :                     :
| `BUILD_TOXAV`          | Whether to      | ON or OFF   | ON                  |
:                        : build the tox   :             :                     :
:                        : AV library.     :             :                     :
| `CMAKE_INSTALL_PREFIX` | Path to where   | Directory   | Platform-dependent. |
:                        : everything      : path.       : Refer to CMake      :
:                        : should be       :             : documentation.      :
:                        : installed.      :             :                     :
| `DHT_BOOTSTRAP`        | Enable building | ON or OFF   | ON                  |
:                        : of              :             :                     :
:                        : `DHT_bootstrap` :             :                     :
| `ENABLE_SHARED`        | Build shared    | ON or OFF   | ON                  |
:                        : (dynamic)       :             :                     :
:                        : libraries for   :             :                     :
:                        : all modules.    :             :                     :
| `ENABLE_STATIC`        | Build static    | ON or OFF   | ON                  |
:                        : libraries for   :             :                     :
:                        : all modules.    :             :                     :
| `MIN_LOGGER_LEVEL`     | Logging level   | TRACE,      | Empty string.       |
:                        : to use.         : DEBUG,      :                     :
:                        :                 : INFO,       :                     :
:                        :                 : WARNING,    :                     :
:                        :                 : ERROR or    :                     :
...
:                        :                 : string) for :                     :
:                        :                 : default.    :                     :
| `STRICT_ABI`           | Enforce strict  | ON or OFF   | OFF                 |
:                        : ABI export in   :             :                     :
:                        : dynamic         :             :                     :
:                        : libraries.      :             :                     :
| `TEST_TIMEOUT_SECONDS` | Limit runtime   | Positive    | Empty string.       |
:                        : of each test to : number or   :                     :
:                        : the number of   : nothing     :                     :
:                        : seconds         : (empty      :                     :
:                        : specified.      : string).    :                     :
| `USE_IPV6`             | Use IPv6 in     | ON or OFF   | ON                  |
:                        : tests.          :             :                     :
...
There are currently no instructions on how to build toxcore on Windows host in
MSYS/Cygwin. Contribution of the instructions is welcome!
...
| --------------------- | ---------------- | ----------------- | ------------- |
| `SUPPORT_ARCH_i686`   | Support building | "true" or "false" | true          |
:                       : 32-bit toxcore.  : (case sensitive). :               :
| `SUPPORT_ARCH_x86_64` | Support building | "true" or "false" | true          |
:                       : 64-bit toxcore.  : (case sensitive). :               :
| `SUPPORT_TEST`        | Support running  | "true" or "false" | false         |
:                       : toxcore          : (case sensitive). :               :
:                       : automated tests. :                   :               :
| `VERSION_OPUS`        | Version of       | Git branch name.  | v1.2.1        |
:                       : libopus to build :                   :               :
:                       : toxcore with.    :                   :               :
| `VERSION_SODIUM`      | Version of       | Git branch name.  | 1.0.18        |
:                       : libsodium to     :                   :               :
:                       : build toxcore    :                   :               :
:                       : with.            :                   :               :
| `VERSION_VPX`         | Version of       | Git branch name.  | v1.6.1        |
:                       : libvpx to build  :                   :               :
:                       : toxcore with.    :                   :               :
...
Debian and Ubuntu packages are available in
[tox.chat's package repository](https://tox.chat/download.html#gnulinux).
