...
/* Check alignment */
typedef char __fail_if_misaligned_1 [ sizeof(struct RTPHeader) == RTP_HEADER_SIZE ? 1 : -1 ];
 ...
 *   initialised. All RTP_HEADER_SIZE bytes will be initialised after a callback
 *   to this function.
