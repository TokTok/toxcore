                      ...
                      void *call_data)
{
    ...
    m_callback_rtp_nos(m, friendnumber, bwc_handle_data, retu);
...
void bwc_kill(BWController *bwc)
{
    ...
    m_callback_rtp_nos(bwc->m, bwc->friend_number, NULL, NULL);
                    ...
                    void *userdata)
{
    ...
    return on_update((BWController *)object, (const struct BWCMessage *)(data + 1), userdata);
}
