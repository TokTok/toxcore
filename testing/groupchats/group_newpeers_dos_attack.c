...
void do_messenger_cycle(Messenger **peers, int peercount, void *userdata)
{
    int j;
...
void idle_n_secs(int n, Messenger **peers, int peercount, void *userdata)
{
    int i;
...
int main(int argc, char *argv[])
{
    ...
    for (i = 0; i < PEERCOUNT; i++) {
        tox[i] = new_messenger(NULL, &options, 0);
        char nick[32];
    ...
    for (;;) {
        do_messenger_cycle(tox, PEERCOUNT, NULL);
    ...
    idle_n_secs(10, tox, PEERCOUNT, NULL);
    ...
    for (i = 0; i < PEERCOUNT; i++) {
        ...
        idle_n_secs(1, tox, PEERCOUNT, NULL);   // comment this out to spam invites as fast as possible
    ...
    idle_n_secs(240, tox, PEERCOUNT, NULL);
