...
See [issue 426](https://github.com/TokTok/c-toxcore/issues/426) for a known
cryptographic weakness we have not yet addressed. The security model has not
yet been fully specified. See [issue
