...
static void run_auto_test(void inner_test(unsigned long con_time, Tox **tox1, Tox **tox2, Tox **tox3))
{
    unsigned long con_time, cur_time = time(NULL);
    ...
    inner_test(con_time, &tox1, &tox2, &tox3);
...
static void various_tox_tests(unsigned long con_time, Tox **tox1, Tox **tox2, Tox **tox3)
{
    uint32_t to_compare = 974536;
...
static void file_transfer_test(unsigned long con_time, Tox **tox1, Tox **tox2, Tox **tox3)
{
...
{
    run_auto_test(various_tox_tests);
    run_auto_test(file_transfer_test);
}
END_TEST
