...
START_TEST(test_announce)
{
    ...
    int frnum_f = onion_addfriend(onions[NUM_FIRST]->onion_c, onion_get_net_crypto(onions[NUM_LAST]->onion_c)->self_public_key);
    int frnum = onion_addfriend(onions[NUM_LAST]->onion_c, onion_get_net_crypto(onions[NUM_FIRST]->onion_c)->self_public_key);
