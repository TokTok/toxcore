...
START_TEST(test_basic)
{
    ...
    ip_init(&ip, 1);
    ip.ip6.uint8[15] = 1;
    Onion *onion1 = new_onion(new_DHT(NULL, new_networking(NULL, ip, 34567), TOX_DHT_NAT_LEVEL_NORMAL));
    Onion *onion2 = new_onion(new_DHT(NULL, new_networking(NULL, ip, 34568), TOX_DHT_NAT_LEVEL_NORMAL));
    ...
    c_sleep(1000);
    Onion *onion3 = new_onion(new_DHT(NULL, new_networking(NULL, ip, 34569), TOX_DHT_NAT_LEVEL_NORMAL));
...
static Onions *new_onions(uint16_t port)
{
    ...
    DHT *dht = new_DHT(NULL, new_networking(NULL, ip, port), TOX_DHT_NAT_LEVEL_NORMAL);
