...
/* NOTE: Packet ids below 24 are reserved for Tox internals, and can't be used
 * by Messenger.
 */
...
typedef struct Messenger {
    ...
    /* TODO replace all enumerated types with the typedefs from tox.h */
