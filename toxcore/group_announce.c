 ...
 */
int handle_gca_request(void *object, IP_Port ipp, const uint8_t *packet, uint16_t length, void *userdata)
{
...
int handle_gca_get_nodes_response(void *object, IP_Port ipp, const uint8_t *packet, uint16_t length, void *userdata)
{
    GC_Announce *announce = object;
...
int handle_gca_ping_response(void *object, IP_Port ipp, const uint8_t *packet, uint16_t length, void *userdata)
{
    GC_Announce *announce = object;
    DHT *dht = announce->dht;
...
int handle_gca_ping_request(void *object, IP_Port ipp, const uint8_t *packet, uint16_t length, void *userdata)
{
    GC_Announce *announce = object;
    DHT *dht = announce->dht;
